...
def get_quantity(decimal: 'pynini.FstLike', cardinal_up_to_hundred: 'pynini.FstLike') -> 'pynini.FstLike':
    ...
    suffix = pynini.union("万", "百万", "千万", "億" "十億", "trillion", "quadrillion", "quintillion", "sextillion")
    res = (
    ...
    res |= decimal + delete_extra_space + pynutil.insert("quantity: \"") + (suffix | "千") + pynutil.insert("\"")
    return res
...
class DecimalFst(GraphFst):
    ...
    def __init__(self, cardinal: GraphFst):
        ...
        graph_decimal |= pynini.string_file(get_abs_path("data/numbers/zero.tsv")) | pynini.cross("零", "０") | pynini.cross("〇", "０")
