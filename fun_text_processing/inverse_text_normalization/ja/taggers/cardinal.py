...
class CardinalFst(GraphFst):
    ...
    def __init__(self, enable_standalone_number: bool = True,
        ...
        million = ((hundred_thousand | ten_thousand | thousand | hundred | teen | tens | digits)
                    ...
                    + (hundred_thousand
                       ...
                       | add_weight(addzero ** 4 + zero + digit,
                                    0.5)
                       | add_weight(digit + addzero ** 5, 0.8)
                       | add_weight(addzero ** 6, 1.0)))
        # 1亿
        hundred_million = ((million | hundred_thousand | ten_thousand | thousand | hundred | teen | tens | digits)
                        + delete('億')
        ...
        # 1兆
        hundred_billion = ((hundred_million | million | hundred_thousand | ten_thousand | thousand | hundred | teen | tens | digits)
                        + delete('兆')
        ...
        # 1.11, 1.01
        number = digits | teen | tens | hundred | thousand | ten_thousand | hundred_thousand | million
        ...
        number = ((number + accep('兆') + delete('零').ques).ques +
                  (number + accep('億') + delete('零').ques).ques + number
                  | (number + accep('兆') + delete('〇').ques).ques +
                  (number + accep('億') + delete('〇').ques).ques + number)
        ...
        if self.enable_standalone_number:
            if self.enable_0_to_9:
                ...
                number_two_plus = (digits + digits.plus) | teen | tens | hundred | thousand | ten_thousand | hundred_thousand | million | hundred_million | hundred_billion
        ...
        graph_hundred_component = graph_hundred_component | graph_a_hundred_digit_component | graph_one_hundred_component | graph_hundred_ties_component
        #
