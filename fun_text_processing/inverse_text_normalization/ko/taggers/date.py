...
graph_digit_inh = pynini.string_file(get_abs_path("data/numbers/digit_inherent_digit.tsv")).optimize()
...
class DateFst(GraphFst):
    ...
    def __init__(self):
        ...
        YEAR_WEIGHT = 0.001
        year_graph = pynutil.insert("year: \"") + pynutil.add_weight(year_graph, YEAR_WEIGHT) + pynutil.insert("\"")
