...
class CardinalFst(GraphFst):
    ...
    def __init__(self):
        ...
        #单位， 百
        #一百一十 一百零六 一百二十 两百
        graph_hundred = graph_digit + pynutil.delete("百") + ( graph_tens
                                                             | graph_teen
        ...
        #五千
        graph_thousand = ( (graph_hundred | graph_teen | graph_tens | graph_digits) + pynutil.delete("千") +
                           ( graph_hundred
        ...
        #单位，万
        graph_ten_thousand = ( (graph_thousand | graph_hundred | graph_teen | graph_tens | graph_digit) + pynutil.delete("万") +
                               ( graph_thousand
        ...
        #单位， 亿/兆
        graph_number = graph_digits | graph_teen | graph_tens | graph_hundred | graph_thousand | graph_ten_thousand

        graph_number = ((graph_number + pynini.accep('兆') + pynutil.delete('零').ques).ques +
                         (graph_number + pynini.accep('亿') + pynutil.delete('零').ques).ques + graph_number)                              
