...
class MoneyFst(GraphFst):
    ...
    def __init__(self, cardinal: GraphFst, decimal: GraphFst):
        ...
        with_hundred = pynini.compose(
            pynini.closure(DAMO_NOT_SPACE) + pynini.accep(" ") + pynutil.insert("ratus ") + DAMO_SIGMA,
        ...
        cents_standalone = (
            ...
            + pynini.union(
                pynutil.add_weight(((DAMO_SIGMA - "satu") @ cardinal_graph), -0.7) @ add_leading_zero_to_double_digit
                + delete_space
                + pynutil.delete("sen"),
