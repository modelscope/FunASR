...
class TimeFst(GraphFst):
    ...
    def __init__(self):
        ...
        labels_hour = ["nol", "satu", "dua", "tiga", "empat", "lima", "enam", "tujuh", "delapan", "sembilan", "sepuluh", "sebelas", "duabelas", "tigabelas"]
        ...
        graph_m_to_h_suffix_time = (
            ...
            + pynutil.insert("\"")
            + pynini.closure(delete_space + pynutil.delete(pynini.union("min", "mins", "menit")), 0, 1)
            + delete_space
