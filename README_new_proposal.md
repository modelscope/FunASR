...
<p align="center"><strong>Industrial speech recognition. 170x faster than Whisper. 50+ languages. Speaker diarization. One API call.</strong></p>

[**Highlights**](#highlights)
| [**Benchmark**](#benchmark)
| [**News**](https://github.com/modelscope/FunASR#whats-new)
...
# Output: timestamped text with speaker labels, punctuation, emotion tags
```

> **Also available as API server:** `funasr-server --device cuda` → OpenAI-compatible endpoint at localhost:8000
...
|                              ERes2NetV2 <br> ([⭐](examples/industrial_data_pretraining/eres2netv2_sv/demo.py) [⭐](https://modelscope.cn/models/iic/speech_eres2netv2_sv_zh-cn_16k-common/summary) )                               |                                                                                                              speaker verification/diarization                                                                                                               |            5000 hours            |    17.8M   |
...
|                                   Qwen3-ASR-1.7B <br> ([⭐](examples/industrial_data_pretraining/qwen3_asr/demo.py) [🤗](https://huggingface.co/Qwen/Qwen3-ASR-1.7B) [🤖](https://modelscope.cn/models/Qwen/Qwen3-ASR-1.7B) )                                   |                                                                                                  speech recognition, 52 languages, auto language detection                                                                                                   |           multilingual           |    1.7B    |
|                                   Qwen3-ASR-0.6B <br> ([⭐](examples/industrial_data_pretraining/qwen3_asr/demo.py) [🤗](https://huggingface.co/Qwen/Qwen3-ASR-0.6B) [🤖](https://modelscope.cn/models/Qwen/Qwen3-ASR-0.6B) )                                   |                                                                                                  speech recognition, 52 languages, auto language detection                                                                                                   |           multilingual           |    0.6B    |
|                                   GLM-ASR-Nano-2512 <br> ([⭐](examples/industrial_data_pretraining/glm_asr/demo.py) [🤗](https://huggingface.co/zai-org/GLM-ASR-Nano-2512) [🤖](https://modelscope.cn/models/ZhipuAI/GLM-ASR-Nano-2512) )                                   |                                                                                          speech recognition, 17 languages, dialect and low-volume speech support                                                                                             |           multilingual           |    1.5B    |
