...
| [TMSpeech](https://github.com/jxlpzqc/TMSpeech) | Windows 会议字幕与翻译工具，可通过外部命令识别器运行 Fun-ASR-Nano INT8。Silero VAD 先完成语音段切分再调用 Nano 解码，同时保留原有低成本 C# 流式识别器。 | [Fun-ASR-Nano 配置](https://github.com/jxlpzqc/TMSpeech/blob/master/README.md#使用-fun-asr-nano)、[识别器源码](https://github.com/jxlpzqc/TMSpeech/blob/master/external_recognizer/simulate-streaming-funasr-nano.py) 和已合并 [#110](https://github.com/jxlpzqc/TMSpeech/pull/110)。 |
