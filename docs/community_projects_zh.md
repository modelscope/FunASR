...
| [Sokuji](https://github.com/kizuna-ai-lab/sokuji) | 实时语音翻译应用，本地推理 sidecar 支持通过 FunASR 使用 GPU-native SenseVoice，也支持离线 CPU/GPU Fun-ASR-MLT-Nano ASR。 | [Sidecar 模型目录](https://github.com/kizuna-ai-lab/sokuji/blob/main/sidecar/sokuji_sidecar/catalog.py)、[native model catalog](https://github.com/kizuna-ai-lab/sokuji/blob/main/src/lib/local-inference/native/nativeCatalog.ts)、已合并 [#268](https://github.com/kizuna-ai-lab/sokuji/pull/268) 和已合并 [#270](https://github.com/kizuna-ai-lab/sokuji/pull/270)。 |
