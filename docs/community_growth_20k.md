...
As of 2026-07-13 18:59 UTC, the ecosystem has 35,355 combined GitHub stars, or 4,131 additional stars since the 31,224 baseline. The remaining gap to the +20,000 target is 15,869 stars by 2026-09-30, which requires roughly 201 stars/day across the remaining 79 days.

| Repository | Stars | Forks | Open issues | Open PRs | Last push |
|---|---:|---:|---:|---:|---|
| `modelscope/FunASR` | 19,203 | 1,927 | 2 | 0 | 2026-07-13 |
| `FunAudioLLM/Fun-ASR` | 1,392 | 137 | 0 | 0 | 2026-07-13 |
| `FunAudioLLM/SenseVoice` | 8,848 | 793 | 0 | 0 | 2026-07-13 |
| `modelscope/FunClip` | 5,912 | 710 | 0 | 0 | 2026-07-13 |
...
| `infiniflow/ragflow#16473` FunASR / SenseVoice STT provider | Adds FunASR to a high-star RAG workflow product where local STT can become a visible configuration choice | Rebased the five-commit integration from a branch point 289 upstream commits behind onto `main@466f33e6`; head `173f88658817` is mergeable with a clean state. `range-diff` shows no semantic PR change, the mocked OpenAI-client provider contract passed, the focused Markdown suite reports 12 passed, and the three visible repository workflow jobs are skipped rather than failed. CodeRabbit accepted a fresh review request without new actionable findings; evidence is at https://github.com/infiniflow/ragflow/pull/16473#issuecomment-4956444898. |
