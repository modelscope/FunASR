...
def main():
    ...
    parser.add_argument("--type", type=str, default="onnx", help='["onnx", "torchscripts", "bladedisc"]')
    ...
    if args.export:
        ...
        if args.type == "torchscripts":
            model_file = os.path.join(model_dir, "model.torchscripts")
            args.device = "cuda"
        elif args.type == "bladedisc":
            model_file = os.path.join(model_dir, "model_blade.torchscripts")
            args.device = "cuda"
