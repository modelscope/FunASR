...
void ParaformerOnline::InitAsr(const std::string &am_model, const std::string &am_cmvn, const std::string &am_config, int thread_num){
    // knf options
...
vector<float> ParaformerOnline::FbankKaldi(float sample_rate, const float* waves, int len) {
...
vector<float> ParaformerOnline::ApplyLfr(const std::vector<float> &in) 
{
  ...
  void ParaformerOnline::ApplyCmvn(std::vector<float> *v)
  {
...
string ParaformerOnline::Forward(float* din, int len, int flag)
{
...
string ParaformerOnline::ForwardChunk(float* din, int len, int flag)
{
