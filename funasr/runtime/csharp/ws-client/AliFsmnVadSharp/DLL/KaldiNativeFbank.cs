...
namespace AliFsmnVadSharp.DLL
{
    public static class KaldiNativeFbank
    {
        ...
        [DllImport(dllName, EntryPoint = "RemoveFbank", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void RemoveFbank(KnfOnlineFbank knfOnlineFbank);
