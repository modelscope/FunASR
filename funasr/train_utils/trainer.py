        ...
        if self.rank == 0:
            ...
            if self.avg_keep_nbest_models_type == "acc":
                if (
                    ...
                    logging.info(
                        f"No improvement in acc: {self.val_acc_step_or_eoch[ckpt_name]:.4f} < {self.val_acc_step_or_eoch[self.best_step_or_epoch]:.4f}, {self.best_step_or_epoch}"
                    )
        ...
        **kwargs,
        ...
        if (batch_idx + 1) % self.log_interval == 0:
            ...
            description = (
                ...
                f"step_in_slice: {batch_idx + 1}/{batch_num_epoch}, step_in_epoch: {step_cur_in_epoch}, total step: {self.batch_total}, "
